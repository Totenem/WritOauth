  ...
  return (
    <div>
      ...
      <select
        ...
        className={`block w-full rounded-md border bg-white px-3 py-2 text-sm text-text focus:outline-none focus:ring-2 focus:ring-primary-500 disabled:bg-bg-muted disabled:text-text-subtle ${
