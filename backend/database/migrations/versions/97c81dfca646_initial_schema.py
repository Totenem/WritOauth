...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_baseline_profiles_student_id"),
        "baseline_profiles",
        ["student_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_subjects_teacher_id"), "subjects", ["teacher_id"], unique=False
    )
    op.create_table(
        "papers",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_papers_student_id"), "papers", ["student_id"], unique=False
    )
    op.create_index(
        op.f("ix_papers_subject_id"), "papers", ["subject_id"], unique=False
    )
    op.create_table(
        "analysis_results",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
